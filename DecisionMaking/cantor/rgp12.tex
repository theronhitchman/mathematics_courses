...
And it will be smaller than $1$, because of the choices above.
...
Of course, the process just keeps going until you get to a point where the left-over part is $x=0$.
...
\begin{exercise}
Try this basic process out with the number $17/93$.
\end{exercise}
