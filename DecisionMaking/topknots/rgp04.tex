...
%\end{tikzpicture}
\includegraphics[height=3in]{knot/topcircle.png}
...
\begin{figure}[h]
\centering
\includegraphics[height=2in]{knot/fig8.png}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{knot/A.png}
     \end{subfigure}
     \qquad
     \begin{subfigure}[b]{0.4\textwidth}
         \centering
         \includegraphics[width=\textwidth]{knot/ABsB.png}
     \end{subfigure}
