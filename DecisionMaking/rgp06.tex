...
\begin{figure}[h]
    ...
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{rgp06pics/r1.png}
        \caption{Type 1 Reidemesiter Moves}
    \end{subfigure}
    \hspace{1in}
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{rgp06pics/r2.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{rgp06pics/r3.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.3\textwidth]{rgp06pics/trefoil-bad-disguise.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.5\textwidth]{rgp06pics/trefoil-better3.png}
    \caption{Finally!}
\end{figure}
...
\begin{figure}[h]
    ...
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{rgp06pics/9SeptQ3a.png}
        \caption{The figure eight knot.}
    \end{subfigure}
    \hspace{2cm}
    \begin{subfigure}{.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{rgp06pics/9SeptQ3b.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=.4\textwidth]{rgp06pics/goeritz.png}
