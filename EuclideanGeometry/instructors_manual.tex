...
Sometimes, the first presenter has a gap in their argument. In which case, I bring up a second person.
When we have a completed argument, we thank the speaker with applause.\\[.1in]
...
What follows is an account of what an instructor should be aware of for each item in the script.
